...
import gifActice from '../../Assets/acticegif/99023-alert-on.gif';
        ...
        <div className='indicator p-1'>
            {
                ...
                <span title='User-verified' className="cursor-pointer indicator-item badge bg-[#0cce0c] w-1 border-none"></span>
