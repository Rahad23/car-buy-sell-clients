    ...
    <div className="bg-[#1B1B1B]">
      <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="relative flex items-center justify-between">
          ...
          >
            <img className='w-[151px]' src={logo} alt="" />
          </Link>
                  ...
                  <nav>
                    <ul className="space-y-4">
                      ...
                      <li>
                        <a
                          href="/"
                          className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-[#b61e8d] hover:bg-[#D926A9] focus:shadow-outline focus:outline-none"
                          aria-label="Sign up"
                          title="Sign up"
                        >
                          Log-in
