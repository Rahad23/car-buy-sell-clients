    ...
    return (
        ...
        <div className="card-body">
            ...
            <div className="card-actions justify-end">
                <Link title='Read-More' to={`/Aston-Martin/${_id}`} className="bg-green-500 p-3 rounded-full">
...
export default AstonMartinCard;